...
class EdirectCommentsGetContentController
{
	...
	public function processConfiguration()
	{
		if (Tools::isSubmit('mymod_pc_form'))
		{
			...
			Configuration::updateValue('EDIRECT_COMMENTS', $enable_comments);
	...
	public function renderForm()
	{
		...
		$helper->tpl_vars = array(
			'fields_value' => array(
				...
				'enable_comments' => Tools::getValue('enable_comments', Configuration::get('EDIRECT_COMMENTS')),
			),
