...
class EdirectCommentsDisplayAdminCustomersController
{
	...
	public function run()
	{
		...
		$nb_comments = EdirectComment::getCustomerNbComments($customer->email);
		...
		// Get comments
		$comments = EdirectComment::getCustomerComments($customer->email, (int)$limit_start, (int)$limit_end);
