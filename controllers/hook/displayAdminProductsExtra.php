...
class EdirectCommentsDisplayAdminProductsExtraController
{
	...
	public function run()
	{
		...
		$nb_comments = EdirectComment::getProductNbComments((int)$id_product);
		...
		$action_url = $this->context->link->getAdminLink('AdminEdirectComments', true);

		// Get comments
		$comments = EdirectComment::getProductComments((int)$id_product, (int)$limit_start, (int)$limit_end);
