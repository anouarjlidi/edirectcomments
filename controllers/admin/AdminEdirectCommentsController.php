...
class AdminEdirectCommentsController extends ModuleAdminController
{
	public function __construct()
	{
		
		$this->table = 'edirect_comment';
		$this->className = 'EdirectComment';
	...
	{
		// Build delete link
		$admin_delete_link = $this->context->link->getAdminLink('AdminEdirectComments').'&deletemymod_comment&id_mymod_comment='.(int)$this->object->id;
